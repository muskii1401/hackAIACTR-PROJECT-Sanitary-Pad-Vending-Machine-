<h1> MENSTRU-BUDDY</H1>
MENSTRU-BUDDY (Sanitary Napkin Vending Machine) is an affordable approach from our side which will provide sanitary napkin to young girls so that they can be stress-free during menstruation allowing them to pick the napkins independently as an when required (based on their need).
